  ...
  return (
    <div className="grid-2">
      ...
      <div className="panel" style={{ gridColumn: 'span 2', border: '1px solid var(--border-color)' }}>
        <div className="panel-title-row">
          <h3 style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontFamily: 'var(--font-display)', fontSize: '2rem', fontWeight: '400', margin: 0 }}>
            ...
            ML Pipeline Evaluation Leaderboard
          </h3>
          <span style={{ fontSize: '12px', color: 'var(--text-muted)', fontFamily: 'var(--font-mono)' }}>
            Ranked by stratified validation accuracy
          </span>
        </div>
              ...
              {leaderboard.map((model, idx) => (
                ...
                >
                  ...
                  <td style={{ fontWeight: idx === 0 ? '700' : '500', color: 'var(--text-primary)' }}>
                    {model.model} {idx === 0 && <span style={{ fontSize: '9px', backgroundColor: 'var(--accent-color)', color: '#ffffff', padding: '2px 6px', borderRadius: '4px', marginLeft: '0.5rem', fontWeight: '700', letterSpacing: '0.05em' }}>BEST CHOICE</span>}
                  </td>
      ...
      <div className="panel" style={{ border: '1px solid var(--border-color)' }}>
        <h3 style={{ fontFamily: 'var(--font-display)', fontSize: '1.75rem', fontWeight: '400', margin: 0 }}>Model Accuracy Comparison</h3>
        <p style={{ fontSize: '13px', color: 'var(--text-secondary)', marginBottom: '1.25rem', marginTop: '4px' }}>
          Side-by-side performance evaluation on test validation set.
        </p>
      ...
      <div className="panel" style={{ border: '1px solid var(--border-color)' }}>
        ...
        <p style={{ fontSize: '13px', color: 'var(--text-secondary)', marginBottom: '1.25rem', marginTop: '4px' }}>
          Attributions represent normalized predictive weights generated by the winning model.
        </p>
